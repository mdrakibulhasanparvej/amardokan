...
export default function Navbar() {
  ...
  const linkClass = (path) =>
    `font-medium transition ${
      pathname === path
        ? "text-[#027CE7] border-b-2 border-[#027CE7]"
        : "text-black hover:text-[#027CE7]"
    }`;
    ...
    <nav className="w-full bg-white shadow-md sticky top-0 left-0 z-10">
      <div className="w-11/12 mx-auto  py-4 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center space-x-1">
          ...
          <h1 className="text-3xl font-bold text-black">AmarDokan</h1>
        </Link>
        ...
        <div className="hidden md:flex space-x-6 text-black font-medium">
          ...
          <div className="relative">
            <button
              ...
              className="cursor-pointer flex items-center text-black hover:text-[#027CE7] font-medium"
            >
            ...
            {dashboardOpen && (
              <div className="absolute mt-4 w-48 bg-white shadow-lg rounded-lg border border-gray-200">
                <Link
                  ...
                  className="block px-4 py-2 text-black hover:bg-[#ff6900]/10 hover:text-[#027CE7]"
                >
                  Add Product
                </Link>
              </div>
