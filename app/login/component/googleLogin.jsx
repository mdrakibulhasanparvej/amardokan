...
export default function SocialLogin() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2  border-[#027CE7] border-2 py-2 rounded-full font-semibold bg-white cursor-pointer hover:bg-gray-100 transition"
    >
