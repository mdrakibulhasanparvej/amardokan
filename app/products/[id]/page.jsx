...
export default async function ProductDetailsPage({ params }) {
  ...
  if (!product) {
    return (
      <p className="text-center mt-20 text-[#027CE7] text-xl font-semibold">
        Product not found
      </p>
    );
  }
  ...
  return (
    <div className="px-4 md:px-8 lg:px-20 py-12">
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[#027CE7] mb-3">
          Product Details
        </h2>
      ...
      <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden md:flex">
        ...
        <div className="p-6 md:w-1/2 flex flex-col justify-between">
          ...
          <div className="mt-4">
            <p className="text-2xl md:text-3xl font-semibold text-[#027CE7] mb-2">
              ${product.price}
            </p>
            ...
            <a
              href="/products"
              className="inline-block w-full text-center bg-[#027CE7] text-white py-3 rounded-full text-lg font-medium transition-all hover:bg-[#0465ba] shadow-md hover:shadow-lg"
            >
              Back to Products
            </a>
          </div>
